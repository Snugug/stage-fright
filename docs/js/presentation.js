...
function buildNotesPreviewLink(index, upcoming = false) {
...
function notesBody(index, current) {
...
export { createPresentation, buildNotesPreviewLink, updateNotes, timing, notesBody };
